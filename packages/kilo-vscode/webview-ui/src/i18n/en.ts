export const dict = {
  ...
  "settings.agentBehaviour.createMode": "Create Custom Mode",
  "settings.agentBehaviour.editMode": "Edit Mode",
  "settings.agentBehaviour.createMode.title": "Create Custom Mode",
  "settings.agentBehaviour.editMode.title": "Edit Custom Mode",
  "settings.agentBehaviour.modeName": "Name",
  "settings.agentBehaviour.modeName.placeholder": "e.g. my-mode",
  "settings.agentBehaviour.modeName.description": "Unique identifier for the mode (lowercase, hyphens allowed)",
  "settings.agentBehaviour.modeDescription": "Description",
  "settings.agentBehaviour.modeDescription.placeholder": "A short description of what this mode does",
  "settings.agentBehaviour.modeDescription.description": "Brief description shown in the mode selector",
  "settings.agentBehaviour.modePrompt": "System Prompt",
  "settings.agentBehaviour.modePrompt.placeholder": "You are an expert at...",
  "settings.agentBehaviour.modePrompt.description": "Custom system prompt / role definition for this mode",
  "settings.agentBehaviour.modeSave": "Save",
  "settings.agentBehaviour.modeCreate": "Create",
  "settings.agentBehaviour.modeNameRequired": "Name is required",
  "settings.agentBehaviour.modeNameInvalid": "Name must be lowercase with hyphens only (e.g. my-mode)",
  "settings.agentBehaviour.modeNameExists": "A mode with this name already exists",
